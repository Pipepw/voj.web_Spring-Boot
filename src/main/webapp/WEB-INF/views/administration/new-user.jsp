...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${BaseUrl}/css/administration/new-user.css?v=<%=version%>" />
    <!-- JavaScript -->
...
<body>
        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <form id="profile-form" onSubmit="onSubmit(); return false;">
                    ...
                    <div class="control-group row-fluid">
                        <label for="trueName"><spring:message code="voj.administration.new-user.trueName" text="trueName" /></label>
                        <input id="trueName" class="span12" type="text" maxlength="64" />
                    </div> <!-- .control-group -->
                    <div class="control-group row-fluid">
                        <label for="stuId"><spring:message code="voj.administration.new-user.stuId" text="Student Number" /></label>
                        <input id="stuId" class="span12" type="text" maxlength="64" />
                    </div> <!-- .control-group -->
                    <div class="control-group row-fluid">
    ...
    <script type="text/javascript">
        function onSubmit() {
            ...
            return doCreateUserAction(username, password, email, trueName, stuId, userGroup, preferLanguage);
        }
    </script>
    <script type="text/javascript">
        function doCreateUserAction(username, password, email, trueName, stuId, userGroup, preferLanguage) {
            var postData = {
                'username': username,
                'password': password,
                'email': email,
    ...
    <script type="text/javascript">
        function processCreateUserResult(result) {
            if ( result['isSuccessful'] ) {
                ...
                if ( result['isTrueNameEmpty'] ) {
                    errorMessage += '<spring:message code="voj.administration.new-user.trueName-empty" text="You can&apos;t leave True Name empty." /><br>';
                }
                if ( result['isStuIdEmpty'] ) {
                    errorMessage += '<spring:message code="voj.administration.new-user.stuId-empty" text="You can&apos;t leave Student Number empty." /><br>';
                }else if ( !result['isStuIdLegal'] ) {
                    errorMessage += '<spring:message code="voj.administration.new-user.stuId-illegal" text="The Student Number seems invalid." /><br>';
                }
                if (result['isGradeEmpty']) {
                    errorMessage += '<spring:message code="voj.administration.new-user.stuId-empty" text="You can&apos;t leave Email empty." /><br>';
                }
