                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="trueName"><spring:message code="voj.administration.all-users.trueName" text="True Name" /></th>
                            <th class="stuId"><spring:message code="voj.administration.all-users.stuId" text="Student Number" /></th>
