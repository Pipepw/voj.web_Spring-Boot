...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${BaseUrl}/css/submissions/submissions.css?v=<%=version%>" />
    <!-- JavaScript -->
...
<body>
    ...
    <script type="text/javascript" src="${BaseUrl}/js/date-${language}.min.js?v=<%=version%>"></script>
    <script type="text/javascript">
