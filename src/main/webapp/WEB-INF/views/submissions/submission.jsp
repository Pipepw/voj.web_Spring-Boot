...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/submissions/submission.css?v=<%=version%>" />
...
<%--                            <c:choose>--%>
<%--                                <c:when test="${isOIModeContest}">--%>
<%--                                    <div id="judge-log" class="description markdown">测评结果将在比赛结束之后公布</div>--%>
<%--                                </c:when>--%>
<%--                                <c:otherwise>--%>
