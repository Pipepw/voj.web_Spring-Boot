        ...
        <div id="discussion-thread">
            <div class="header row-fluid">
                ...
                <c:if test="${myProfile.uid == discussionThread.discussionThreadCreator.uid}">
                    <!-- TODO -->
                    <button class="btn btn-default hide" onclick="editDiscussion();"><spring:message code="voj.discussion.thread.edit-discussion" text="Edit" /></button>
                </c:if>
                <c:if test="${isLogin}">
            ...
            <div class="body row-fluid">
                <div class="span9">
                    ...
                    <div id="editor" class="row-fluid">
                        <div class="span2">
                            <div class="avatar">
                                <img src="${cdnUrl}${currentUserAvatar}?v=${version}" alt="gravatar">
                            </div> <!-- .avatar -->
                        </div> <!-- .span2 -->
                        <div class="span10">
    ...
    <script type="text/javascript">
        function getDiscussionReplyContent(discussionReplyId, discussionReplyCreator, discussionReplyCreateTime, discussionReplyContent, discussionReplyVotes) {
            ...
            var replyHtml =
                ...
                '            <img src="${cdnUrl}%s?v=${version}" alt="gravatar" />'.format(discussionReplyCreator['avatarUrl']) +
                '        </div> <!-- .avatar -->' + 
                '    </div> <!-- .span2 -->' + 
                '    <div class="span10">' + 
