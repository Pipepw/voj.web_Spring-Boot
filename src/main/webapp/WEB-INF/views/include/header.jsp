...
<%--                    <img src="${cdnUrl}/img/logo.png?v=${version}" alt="Logo" />--%>
            ...
            <div id="nav" class="span6">
                <ul class="inline">
                    ...
                    <li><a href="<c:url value="/submission/submissionRank" />"><spring:message code="voj.include.header.acRank" text="ACRank" /></a></li>
                ...
                <div>
                    ...
                    <form class="changeAvatar" method="post" onSubmit="changeAvatar(${myProfile.uid}); return false;"
                        ...
                        <div style="display: flex;">
                            <button id="problem-import" class="btn" type="submit"><spring:message code="voj.include.header.changeAvatar" text="changeAvatar" /></button>
